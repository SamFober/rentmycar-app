...
@Composable
fun AllRentals(platlist: List<Rental>, onDetailButtonPressed: (Int) -> Unit, onAddCarButtonPressed: () -> Unit) {
    Scaffold(
        topBar = {
            TopAppBar(
        ...
        Column(
            ...
            LazyColumn(
                ...
                items(platlist) {
                    MyCarCard(it.name, it.description, it.imageRes, it.id, onDetailButtonPressed = onDetailButtonPressed)
                }
            }
        }
        Column(
